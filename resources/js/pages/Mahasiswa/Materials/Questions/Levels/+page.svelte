...
<App title={`Tantangan - ${material.title}`}>
    <div class="space-y-12">
        ...
        <div class="max-w-6xl mx-auto space-y-12">
            <!-- Accuracy Info Alert (Only for role_id 3, assuming current user role check logic) -->
            <!-- Since we don't pass user role explicitly, we skip or use $page.props.auth.user -->
