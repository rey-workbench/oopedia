    ...
    >
        {#each podiumItems as item, index}
            {#if index === 0}
                <!-- 2nd Place -->
                <div
                    class="animate-fade-in-up z-10 flex flex-1 flex-col items-center"
                ...
                >
                    {#if item}
                        ...
                        <div
                            class="relative flex h-28 w-full flex-col items-center justify-start overflow-hidden rounded-t-2xl border-x border-t border-slate-600/50 bg-linear-to-t from-slate-800 to-slate-700/80 pt-4 backdrop-blur-sm md:h-36"
                        >
                            <div
                                class="absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-slate-300 to-transparent opacity-50"
                            ></div>
            ...
            {:else if index === 1}
                <!-- 1st Place -->
                <div
                    class="animate-fade-in-up z-20 -mb-2 flex flex-1 flex-col items-center md:-mb-4"
                    style="animation-delay: 400ms;"
                >
                    {#if item}
                        <div class="group relative mb-5">
                            <div
                                class="absolute -top-12 left-1/2 -translate-x-1/2 text-amber-400 drop-shadow-[0_0_10px_rgba(251,191,36,0.6)]"
                            >
                        ...
                        <div
                            class="relative flex h-40 w-full flex-col items-center justify-start overflow-hidden rounded-t-2xl border-x border-t-2 border-amber-500/50 bg-linear-to-t from-amber-900/80 to-amber-600/40 pt-4 backdrop-blur-md md:h-48"
                        >
                            <div
                                class="absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-amber-300 to-transparent opacity-80"
                            ></div>
            ...
            {:else}
                ...
                >
                    {#if item}
                        ...
                        <div
                            class="relative flex h-24 w-full flex-col items-center justify-start overflow-hidden rounded-t-2xl border-x border-t border-rose-900/40 bg-linear-to-t from-slate-800 to-slate-700/60 pt-4 backdrop-blur-sm md:h-32"
                        >
                            <div
                                class="absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-rose-400 to-transparent opacity-40"
                            ></div>
                            <div class="text-4xl font-black tracking-tighter text-slate-600/30">
                                3
                            </div>
