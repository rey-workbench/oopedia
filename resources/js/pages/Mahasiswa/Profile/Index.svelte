...
<App title="Profil Mahasiswa">
    <div class="space-y-12">
        <PageHeader title="Profil Saya" subtitle="Atur informasi akun dan keamanan Anda untuk pengalaman belajar yang lebih personal.">
            <div class="mt-6 flex flex-wrap gap-4">
                <div>
                    <div class="flex items-center gap-2 px-4 py-2 bg-emerald-50 text-emerald-600 rounded-2xl border border-emerald-100">
                        <ShieldCheck size={16} />
                        <span class="text-[10px] font-bold uppercase tracking-widest">Akun Terverifikasi</span>
                    </div>
                </div>
            </div>
        </PageHeader>
