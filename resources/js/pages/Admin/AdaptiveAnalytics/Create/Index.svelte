...
<App title="Arsitek Aturan Adaptif - Tambah">
    <div class="space-y-12 pb-20">
        <PageHeader
            id="page-header"
            title="Arsitek Aturan Adaptif"
            subtitle="Definisikan logika adaptif baru untuk orkestrasi pembelajaran."
        >
            {#snippet actions()}
            ...
            <div class="group relative overflow-hidden rounded-3xl border border-slate-100 bg-white p-6 shadow-2xl transition-transform duration-300 hover:-translate-y-1">
                ...
                <div class="space-y-10 p-6">
                        ...
                        <div class="space-y-6">
                            <Alert variant="primary" class="bg-primary-50/50 border-primary-100 p-6">
                                <div class="flex gap-4">
                                    ...
                                    <div class="space-y-1">
                                        <h4 class="text-[11px] font-black text-primary-900 uppercase tracking-wider">Panduan Logika Evaluasi</h4>
                                        <p class="text-[10px] leading-relaxed font-bold text-slate-500 uppercase">
                                            Sistem menggunakan <span class="text-primary-700">Forward Chaining</span>. Prioritas dengan angka <span class="text-primary-700">terkecil</span> akan dievaluasi pertama kali dalam barisan antrean.
                                        </p>
                                    </div>
                                </div>
                            </Alert>
                            ...
                            <div class="rounded-3xl border border-slate-100 bg-slate-50/30 p-8 flex flex-col items-center justify-center text-center gap-4">
                                ...
                                <div class="space-y-1">
                                    <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Kesiapan Logika</span>
                                    <p class="text-xs font-bold text-slate-800">Pastikan dependensi fakta telah dikonfigurasi dengan benar di bawah ini.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-6 border-t border-slate-100 pt-10">
                        ...
                        >
                            {form.processing ? 'MEMPROSES...' : 'SIMPAN ATURAN BARU'}
                        </Button>
                    </div>
                </div>
            </div>
