            ...
            <div class="mt-6 flex flex-wrap items-center justify-between gap-6">
                ...
                >
                    ...
                    <div>
                        ...
                        >
                            ID: {state.survey.id.substring(0, 8)} • {state.survey
                                .assessment_type === 'pre'
                                ? 'Pre-Test (Awal)'
                                : 'Post-Test (Akhir)'}
                        </div>
        ...
        <div class="grid grid-cols-1 gap-10 lg:grid-cols-3">
            <div id="ueq-respondent-profile" class="space-y-8">
                <Card class="rounded-3xl border-none bg-slate-900 p-10 text-white shadow-2xl">
                    <div class="mb-8 text-center">
                        ...
                        >
                            <div class="h-1 w-1 animate-pulse rounded-full bg-emerald-400"></div>
                            Verified Submission
                        </div>
                        <h4
                            class="mb-2 text-[10px] font-bold tracking-[0.3em] text-slate-500 uppercase"
                        >
                            UEQ Validitas
                        </h4>
                        <div class="text-4xl font-black tracking-widest text-white">VALID</div>
                    </div>
                ...
                <div id="ueq-dimension-scores" class="space-y-4">
                    ...
                    {#each Object.entries(state.dimensions) as [key, value]}
                        <div
                            class="group space-y-3 rounded-2xl bg-slate-50 p-5 transition-all hover:bg-white hover:shadow-xl"
                        >
            ...
            <div class="space-y-10 lg:col-span-2">
                <div id="ueq-user-feedback" class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <Card class="border-primary-100 bg-primary-50/30 rounded-[2rem]">
