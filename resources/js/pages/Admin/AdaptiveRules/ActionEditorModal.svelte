    ...
    <div class="flex max-h-[90vh] flex-col bg-white">
        ...
        <div class="custom-scrollbar flex-1 overflow-y-auto p-6">
            <form id="action-form" onsubmit={handleSubmit} class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <textarea
                            ...
                            class="focus:border-primary-500 min-h-[250px] w-full rounded-2xl border-2 border-slate-100 bg-slate-900 p-4 font-mono text-xs leading-relaxed text-emerald-400 focus:ring-0"
                            spellcheck="false"
                        ></textarea>
                        {#if jsonError}
                ...
                <Alert variant="info" class="border-slate-200 bg-slate-50">
                    <div class="flex gap-4">
                        ...
                        <div class="space-y-1 text-[11px] font-bold text-slate-600">
                            ...
                            <ul class="list-disc space-y-0.5 pl-4">
                                <li>
                                    <code class="text-primary-600">flow</code>: NEXT, UP, DOWN,
                                    REVIEW, FINISH
                                </li>
                                <li>
                                    <code class="text-primary-600">title</code>: Judul modal
                                    feedback
                                </li>
                                <li>
                                    <code class="text-primary-600">message</code>: Pesan untuk
                                    mahasiswa
                                </li>
                                <li>
                                    <code class="text-primary-600">xp</code>,
                                    <code class="text-primary-600">streak</code>,
                                    <code class="text-primary-600">target_difficulty</code>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        >
            <button
                type="button"
                onclick={onclose}
                class="text-sm font-bold text-slate-500 hover:text-slate-700">Batal</button
            >
            <Button
                type="submit"
                form="action-form"
