    ...
    <div class="group relative">
        <textarea
            ...
            class={`
                ...
                ${disabled ? 'cursor-not-allowed border-cosmos-border bg-slate-50 text-slate-400 grayscale' : 'bg-white'}
                ${
                    error
                        ? 'border-rose-200 bg-rose-50/20 text-rose-900 focus:border-rose-500 focus:ring-4 focus:ring-rose-50'
                        : 'hover:border-primary-400 focus:border-primary-500 border-cosmos-border focus:ring-4 focus:ring-primary-100'
                }
            `}
        ></textarea>
