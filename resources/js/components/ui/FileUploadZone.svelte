...
<div class="space-y-4">
    ...
    <label class="group block w-full cursor-pointer">
        ...
        <div
            class="hover:border-primary-400 hover:bg-primary-50/50 border-cosmos-border flex flex-col items-center justify-center gap-6 rounded-[2rem] border-2 border-dashed p-16 transition-all"
        >
            <div
                class="group-hover:bg-primary-100 group-hover:text-primary-600 bg-primary-50 text-primary-300 flex h-16 w-16 items-center justify-center rounded-2xl transition-all"
            >
