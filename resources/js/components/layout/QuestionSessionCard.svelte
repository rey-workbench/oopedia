            ...
            <div class="flex flex-col items-center justify-between gap-6 px-4 py-2 sm:flex-row">
                ...
                >
                    ...
                    >
                        <Target
                            size={18}
                            class="transition-colors duration-500 {accuracyClass.icon}"
                        />
                        <span
                            class="text-lg font-black tracking-tight transition-colors duration-500 {accuracyClass.text}"
    ...
    {#if studentState?.adaptive_state?.['show_motivation']}
        ...
        >
            ...
            <p class="mt-1 text-sm text-blue-500">
                Sistem menyiapkan soal yang lebih mudah untukmu. Jawab dengan tenang dan percaya
                diri!
            </p>
        </div>
    {/if}
