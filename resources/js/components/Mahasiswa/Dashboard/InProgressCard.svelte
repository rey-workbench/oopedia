    ...
    >
        ...
        <div class="p-8 bg-primary-600 relative overflow-hidden text-white">
            ...
            <div class="relative z-10 flex items-center gap-6">
                ...
                >
                    <Loader2 size={32} strokeWidth={2.5} class="animate-spin" />
                </div>
                ...
                <div>
                    ...
                    <div class="text-3xl font-bold text-slate-900">
                        ...
                        <span class="text-sm text-slate-400 ml-2"
                            >/ {materialData.stats.overall.total} SELESAI</span
                        >
                    </div>
                </div>
            ...
            <div class="space-y-4 mb-10">
                ...
                >
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="text-xs font-bold text-slate-900">
                            {materialData.stats.beginner.correct}/{materialData
                                .stats.beginner.configured_total}
                        </span>
                    </div>
                    <div
                ...
                >
                    <div class="flex justify-between items-center mb-2">
                        ...
                        >
                        <span class="text-xs font-bold text-slate-900">
                            {materialData.stats.medium.correct}/{materialData
                                .stats.medium.configured_total}
                        </span>
                    </div>
                    <div
                        class="h-1.5 w-full bg-slate-200 rounded-full overflow-hidden"
                ...
                >
                    <div class="flex justify-between items-center mb-2">
                        ...
                        >
                        <span class="text-xs font-bold text-slate-900">
                            {materialData.stats.hard.correct}/{materialData
                                .stats.hard.configured_total}
                        </span>
                    </div>
                    <div
                        class="h-1.5 w-full bg-slate-200 rounded-full overflow-hidden"
