                ...
                <div class="space-y-10">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <div class="lg:col-span-1 space-y-4">
                            <label class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 block">Visualisasi Sampul</label>
                            <div id="imagePreview" class="relative group aspect-video rounded-2xl bg-slate-50 border-2 border-dashed border-slate-200 flex flex-col items-center justify-center overflow-hidden transition-all hover:border-blue-500/50">
                                ...
                                <div id="preview_placeholder" class="text-center group-hover:scale-110 transition-transform">
                                    ...
                                    <p class="text-[9px] font-black uppercase tracking-widest text-slate-400">Unggah Sampul</p>
                                </div>
                    ...
                    <div class="pt-6 border-t border-slate-100 flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-[10px] font-black uppercase tracking-widest text-slate-400">Status Kesiapan: Siap Dipublikasikan</span>
                        </div>
