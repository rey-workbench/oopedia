            ...
            >
                    ...
                    <div class="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <x-forms.form-group label="Modul Asal" name="material_id" required>
                            @if (isset($material))
                                ...
                                <div class="px-6 py-4 bg-indigo-50/50 border border-indigo-100 rounded-2xl text-sm font-black italic text-indigo-900 border-l-4 border-l-indigo-600 uppercase">
                                    {{ $material->title }}
                                </div>
                            @else
                    ...
                    <div class="lg:col-span-1">
                        <div class="h-full p-8 bg-indigo-950 rounded-[2rem] relative overflow-hidden flex flex-col justify-center">
                            ...
                            <div class="relative z-10 flex flex-col items-center text-center">
                                ...
                                <h4 class="text-white text-xs font-black uppercase tracking-widest mb-2 italic">Rekonfigurasi Aktif</h4>
                ...
                <div class="pt-8 border-t border-slate-100">
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <x-ui.button type="button" id="add-answer-btn" onclick="addAnswer()" variant="ghost" size="sm" class="text-indigo-600 font-black italic uppercase tracking-widest" icon="fas fa-plus">
                            TAMBAH PILIHAN
                        </x-ui.button>
                    </div>
                            ...
                            <div class="answer-entry group">
                                    ...
                                    <div class="flex items-center gap-4 bg-slate-50/50 p-4 rounded-2xl border border-slate-100 transition-all hover:border-emerald-200">
                                        ...
                                        <div class="flex items-center gap-6">
                                            <label class="flex items-center gap-3 cursor-pointer">
                                                ...
                                                <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 peer-checked:text-emerald-600">Correct Item</span>
                                            </label>
                                            <button type="button" onclick="this.closest('.answer-entry').remove()" class="text-slate-300 hover:text-red-500 transition-colors">
                                                <i class="fas fa-times-circle"></i>
                                            </button>
                                ...
                                @else {{-- fill_in_the_blank --}}
                                    <div class="bg-blue-50/30 p-10 rounded-[2.5rem] border-2 border-dashed border-blue-100 text-center">
                                        <p class="text-[10px] font-black uppercase tracking-[0.2em] text-blue-400 mb-6">Target Keyphrase Detection</p>
                                        <input type="text" name="answers[{{ $index }}][answer_text]" 
                ...
                <div class="pt-10 border-t border-slate-100 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-[10px] font-black uppercase tracking-widest text-slate-400">Sinkronisasi Cloud: Siap mengirimkan pembaruan</span>
                    </div>
                    <x-ui.button type="submit" variant="primary" size="lg" class="shadow-xl shadow-indigo-500/20 bg-indigo-600 hover:bg-indigo-700 font-black italic tracking-tighter" icon="fas fa-cloud-upload-alt">
                        SIMPAN PERUBAHAN
                    </x-ui.button>
                </div>
            </form>
                    ...
                    <div class="flex items-center gap-4 bg-slate-50/50 p-4 rounded-2xl border border-slate-100 transition-all hover:border-blue-200">
                        ...
                        <div class="flex items-center gap-6">
                            <label class="flex items-center gap-3 cursor-pointer">
                                ...
                                <span class="text-[10px] font-black uppercase tracking-widest text-slate-400 peer-checked:text-blue-600">Mark Correct</span>
