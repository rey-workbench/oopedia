          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div class="flex items-center">
                ...
                <span class="text-slate-900 font-bold tracking-widest uppercase">{{ $titlePage }}</span>
              </div>
            </li>
          </ol>
        </nav>
    ...
    <div class="flex items-center gap-2 sm:gap-4">
      @auth
        <div class="hidden md:flex flex-col items-end mr-2">
          <span class="text-sm font-bold text-slate-900 leading-none">{{ $userName }}</span>
      ...
      @else
        <div class="flex items-center gap-2">
          <a href="{{ route('login') }}" class="px-6 py-2.5 text-sm font-bold uppercase tracking-widest text-slate-600 hover:text-blue-600 transition-all">Masuk</a>
          <a href="{{ route('register') }}" class="px-6 py-2.5 bg-slate-900 text-white text-sm font-bold uppercase tracking-widest rounded-xl hover:bg-blue-600 transition-all shadow-lg shadow-slate-200">Daftar</a>
        </div>
      @endauth
    </div>
  </div>
