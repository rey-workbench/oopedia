...
@php
  ...
  $baseClasses = 'w-full px-6 py-4 bg-white border border-slate-100 rounded-2xl font-bold tracking-widest text-slate-900 transition-all duration-300 appearance-none';
