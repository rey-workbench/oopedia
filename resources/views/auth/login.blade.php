      ...
      <x-ui.card padding="p-10" :hover="false">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
          ...
          <div class="relative py-4">
            ...
            <div class="relative flex justify-center text-[10px] uppercase font-bold tracking-widest"><span class="bg-white px-4 text-slate-400">Atau</span></div>
          </div>
          ...
          <div class="flex flex-col gap-4">
            ...
            <a href="{{ route('guest.login') }}" class="flex items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-widest text-slate-400 hover:text-slate-900 transition-colors">
