            ...
            <x-ui.card padding="p-10" :hover="false">
                <x-slot:header>
                    <div class="text-center w-full" data-intro="Belum punya akun? Daftarkan diri Anda untuk mulai belajar Pemrograman Berorientasi Objek secara interaktif." data-step="1">
                        <h3 class="text-xl font-black italic tracking-tight text-slate-900">BUAT AKUN BARU</h3>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div class="relative py-4">
                        ...
                        <div class="relative flex justify-center text-[10px] uppercase font-black tracking-widest italic"><span class="bg-white px-4 text-slate-400">Sudah punya akun?</span></div>
                    </div>
