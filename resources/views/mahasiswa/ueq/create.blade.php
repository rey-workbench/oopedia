        ...
        <div class="p-8 md:p-12 border-b border-gray-50 bg-gray-50/50">
          ...
          <form id="ueqForm" method="POST" action="{{ route('mahasiswa.ueq.store') }}" class="space-y-12">
            ...
            <div class="pt-8 flex justify-center">
              <button type="submit" class="group relative px-16 py-5 bg-gray-900 text-white rounded-[2rem] font-bold tracking-widest uppercase overflow-hidden hover:bg-blue-600 transition-all shadow-2xl hover:shadow-blue-200 scale-100 active:scale-95">
