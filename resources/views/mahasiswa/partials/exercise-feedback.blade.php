        ...
        <div class="bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 overflow-hidden">
            <div id="feedbackBanner" class="p-12 text-center text-white relative transition-colors duration-500">
                ...
                <div class="relative z-10">
                    ...
                    <h2 id="feedbackStatus" class="text-4xl font-black italic tracking-tight uppercase mb-2"></h2>
                    <p id="feedbackSubStatus" class="text-white/80 font-medium italic"></p>
                </div>
            </div>
                ...
                <div id="feedbackDetails">
                    <div id="explanationBox" class="bg-gray-50 rounded-3xl p-8 border border-gray-100 mb-8" style="display: none;">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h5 class="text-sm font-black text-gray-900 uppercase tracking-widest italic">Analisis Jawaban</h5>
                        </div>
                        <div id="explanationText" class="text-gray-600 leading-relaxed font-medium italic"></div>
                    </div>
                </div>
                
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <button id="tryAgainBtn" style="display: none;" 
                            class="flex items-center justify-center gap-3 px-10 py-4 bg-amber-500 text-white rounded-2xl font-black italic uppercase tracking-widest transition-all shadow-lg shadow-amber-100 hover:shadow-amber-200 hover:-translate-y-1">
                        <i class="fas fa-redo"></i>
                        Coba Lagi
                    </button>
                    <button id="nextQuestionBtn" style="display: none;" 
                            class="flex items-center justify-center gap-3 px-10 py-4 bg-gray-900 text-white rounded-2xl font-black italic uppercase tracking-widest hover:bg-blue-600 transition-all shadow-xl shadow-gray-200 hover:shadow-blue-200 hover:-translate-y-1">
