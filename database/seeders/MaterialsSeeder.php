    ...
    public function run(): void
    {
        $materials = [
            [
                ...
                <p>Penerapan OOP di industri modern menjadi standar karena mendukung prinsip-prinsip pengembangan yang tangguh, seperti <em>Code Reusability</em> (penggunaan kembali kode) dan <em>Extensibility</em> (kemudahan pengembangan fitur baru). Memahami dasar OOP adalah langkah krusial bagi setiap pengembang yang ingin membangun sistem skala besar yang efisien dan mudah dirawat.</p>',
                'module_id' => 1,
                'created_by' => 2,
            ],
            [
