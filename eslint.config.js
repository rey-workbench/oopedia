...
const browserGlobals = {
  ...
  Event: 'readonly', InputEvent: 'readonly', MouseEvent: 'readonly',
  KeyboardEvent: 'readonly', DragEvent: 'readonly', SubmitEvent: 'readonly',
  FocusEvent: 'readonly', PointerEvent: 'readonly',
  setTimeout: 'readonly', clearTimeout: 'readonly', setInterval: 'readonly', clearInterval: 'readonly',
  requestAnimationFrame: 'readonly', cancelAnimationFrame: 'readonly',
  fetch: 'readonly', FormData: 'readonly', FileReader: 'readonly', File: 'readonly', Blob: 'readonly',
  ...
  DOMParser: 'readonly', history: 'readonly', location: 'readonly',
  performance: 'readonly', crypto: 'readonly',
  globalThis: 'readonly', self: 'readonly',
  Promise: 'readonly', Map: 'readonly', Set: 'readonly', WeakMap: 'readonly', WeakSet: 'readonly',
  Symbol: 'readonly', Proxy: 'readonly', Reflect: 'readonly',
  Int8Array: 'readonly', Uint8Array: 'readonly', Float32Array: 'readonly', Float64Array: 'readonly',
}
